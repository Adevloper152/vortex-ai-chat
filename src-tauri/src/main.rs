...
fn main() {
    tauri::Builder::default()
        ...
        .setup(|app| {
            #[cfg(target_os = "macos")]
            {
                let app_menu = SubmenuBuilder::new(app, "vortertex AI Chat")
                    .items(&[
                        &MenuItemBuilder::with_id("about", "About vortertex AI Chat").build(app)?,
                ...
                let help_menu = SubmenuBuilder::new(app, "Help")
                    .items(&[
                        &MenuItemBuilder::with_id("help", "vortertex AI Chat Help").accelerator("Cmd+?").build(app)?,
                    ])
                    .build()?;
